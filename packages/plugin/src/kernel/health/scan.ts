...
/** The full tiered findings — the structure both `obsidian_health` and
 *  `obsidian_lint` return (lint returns a scope-filtered copy). */
...
/**
 * Restrict findings to a single folder/note scope, for `obsidian_lint`. A pure
