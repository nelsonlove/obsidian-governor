...
[vocabulary provider](vocabulary.md) — are not hard-wired into the tool surface. They are
...
| `vocab` | capability | `vocabulary` | `obsidian_vocabularies`, `obsidian_resolve_term`, `obsidian_validate_terms`, `obsidian_list_vocabulary` | [vocabulary.md](vocabulary.md) |
